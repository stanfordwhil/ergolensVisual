...
{
    private static readonly float PanSpeed = 150f;
    private static readonly float ZoomSpeedTouch = 0.1f;
    private static readonly float ZoomSpeedMouse = 0.5f;

    private static readonly float[] BoundsX =  { -10f, 5f };
    private static readonly float[] BoundsZ = { -18f, -4f };
    private static readonly float[] ZoomBounds = { 10f, 85f };
    ...
    void PanCamera(Vector3 newPanPosition)
    {
        ...
        Vector3 move = new Vector3(offset.x * PanSpeed, offset.y * PanSpeed, offset.x * PanSpeed);
